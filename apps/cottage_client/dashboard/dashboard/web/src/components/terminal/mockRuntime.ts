  ...
  proposals: [
    {
      ...
      from: 'dock',
      to: 'kitchen',
      warnings: ['No candidate robot is currently available for the outdoor pickup stages.'],
      blockingReasons: [],
      summary: 'Mission decomposed into staged pickup, transfer, and indoor handoff.',
      steps: [
        { id: 'step-1', summary: 'Stage groceries at dock for transfer' },
        { id: 'step-2', summary: 'Transfer groceries from dock to entry' },
        { id: 'step-3', summary: 'Complete indoor delivery of groceries to kitchen', topCandidate: 'Carrier 02' },
      ],
    },
  ],
  alerts: [
