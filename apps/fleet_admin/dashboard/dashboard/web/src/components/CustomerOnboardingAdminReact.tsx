...
const FleetCard: React.FC<{ fleet: Fleet; onConfigure: (fleet: Fleet) => void }> = ({ fleet, onConfigure }) => {
        ...
        <div className="bg-white rounded-lg shadow p-6 border border-gray-200">
            <div className="p-4">
                ...
                <div className="text-gray-600">
                    <div>Robots: {fleet.robot_count}</div>
                    <div>Active Tasks: {fleet.active_tasks}</div>
                    <div>Status: {fleet.deployment_status}</div>
                </div>
            </div>
            <div className="mt-4">
                <button
