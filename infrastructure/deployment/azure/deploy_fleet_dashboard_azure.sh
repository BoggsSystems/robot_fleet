...
# Deploy Fleet Dashboard to Azure Container App
echo "🚀 Deploying Fleet Dashboard to Azure Container App"
...
# Build Docker image
echo "📦 Building Fleet Dashboard Docker image..."
...
echo "🌐 Fleet Dashboard is available at: https://${APP_URL}"
...
echo "   - Replicas: 1-3 (auto-scaling)"
